...
String data2;
const String data1 = "https://script.google.com/macros/s/AKfycbwNlEpWTplliWtelgs-CVUuf1vgEt_ey_KJsxG_sBVfTEz6ti_9PMHaHiU3rjAfO9i5/exec?name=";
...
void setup() 
{
  ...
  WiFiMulti.addAP("Naaima_Network", "6106@2020@kada");
